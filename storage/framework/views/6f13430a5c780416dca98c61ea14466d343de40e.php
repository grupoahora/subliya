...
<?php $__env->startSection('contentbody'); ?>
    <?php if(session('messagecontactanos')): ?>
    ...
    <div class="paralax">
        <div class="" id="gallery-paralax-1"></div>
    ...
    <div class="startBody">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-center  " id="QuienesSomos">
            ...
            <div
                class="row justify-content-center align-content-center align-items-center g-2 g-lg-3 h-100   mx-auto w-75 my-autosubliya">
                <div
        ...
        <div class="container-fluid " id="Servicios">
            ...
            <div
                class="row justify-content-start  align-content-start align-items-start g-2 g-lg-3 h-100  mx-auto w-100  my-autosubliya">
                <div
                ...
                <div
                    ...
                    <a href="<?php echo e(route('get.detail.all')); ?>" target="_blank" rel="noopener noreferrer">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-sm-center justify-content-lg-center ">
                <div class="card border-0 px-3 px-lg-0 mt-5 mt-lg-0">
                    <div class="card-body  card-contact-subliya me-0 me-lg-5 ">
                        ...
                        <form action="<?php echo e(route('contactanos')); ?>" method="post" class="form-contacto mx-4 ">
                            <?php echo csrf_field(); ?>
                            <div class="">
...
<?php echo $__env->make('layouts.subliyamaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\subliya\resources\views/welcome.blade.php ENDPATH**/ ?>