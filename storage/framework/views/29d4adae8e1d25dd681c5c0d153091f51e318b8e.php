                ...
                <div class="d-flex flex-column justify-content-start align-items-center w-75 h-75">
                    <div class="me-auto py-4">
                        ...
                        <select name="select-disenos" class="select-disenos" id="category_id" style="width: 100%"
                            ...
                            <optgroup label="Categorías">
                                ...
                                <?php $__currentLoopData = $categoriesweb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($categoryselect)): ?>
                                        <?php if($categoryselect->id == $category->id): ?>
                    ...
                    <div class="d-flex justify-content-end align-items-end w-100 py-4">
                        <div class=" icon-disenos">
                            <button
                                class="<?php if($view == 0): ?> icon-disenos-onsection <?php else: ?> icon-disenos-offsection <?php endif; ?>  mx-3 "
                                id="icon-disenos-onsection" onclick="changeSection(0)"
                                <?php if($view == 0): ?> disabled <?php else: ?> <?php endif; ?>>
                            ...
                            <button
                                class="<?php if($view == 0): ?> icon-disenos-offsection <?php else: ?> icon-disenos-onsection <?php endif; ?> "
                                id="icon-disenos-offsection" onclick="changeSection(1)"
                                <?php if($view == 1): ?> disabled <?php else: ?> <?php endif; ?>>
        ...
        <div class="container-fluid width-designs me-sm-0 mx-auto">
            ...
            <div class="row d-flex flex-row justify-content-center align-items-center card-group-disenos asdasdas">
                <?php $__currentLoopData = $designsweb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 <?php if($view == 0): ?> col-md-2 mx-3 <?php else: ?> <?php endif; ?>  p-0 desings mb-3 "
                        id="">
                        <div class="card border-0 d-flex flex-row justify-content-center ">
                            <a href="<?php echo e(route('get.detail.design', $design->id)); ?>">

                                <?php $__currentLoopData = $design->records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($loop->first): ?>
                                        
                                        <img src="<?php echo e($record->url); ?>"
                                            class="<?php if($view == 0): ?> card-img-top <?php else: ?> card-img-top-list <?php endif; ?>  animate"
                                            alt="Imagen del producto">
                                    <?php else: ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($design->records) == 0): ?>
                            ...
                            <div class="card-body <?php if($view == 0): ?> d-none <?php else: ?> <?php endif; ?>  desingsCardBody ">
                                
                                <h5 class="card-title"><?php echo e($design->name); ?></h5>
                                <p class="card-text ">
                                    <?php if(!isset(explode(' ', $design->description, 14)[13])): ?>
                                        <?php echo $design->description; ?>

                                    <?php endif; ?>
                                    <?php if(isset(explode(' ', $design->description, 14)[13])): ?>
                                        <?php for($i = 0; $i < 13; $i++): ?>
                                            <?php echo explode(' ', $design->description, 14)[$i]; ?>

                                        <?php endfor; ?>
                                        <span id="oculto<?php echo e($design->id); ?>" class="d-none">
                                            <?php echo explode(' ', $design->description, 14)[13]; ?>

                                        </span>
                                    <?php endif; ?>
                                </p>
                            </div>
                            <a class="description-vermas <?php if($view == 0): ?> d-none <?php else: ?> <?php endif; ?> "
                                href="<?php echo e(route('get.detail.design', $design->id)); ?>">
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function changeCategory(category) {
            ...
            $.ajax({
                url: "<?php echo e(route('get.subcategoriesbycategoryunique')); ?>",
                method: 'GET',
                data: {
            ...
            $.ajax({
                url: "<?php echo e(route('get.designsbycategory')); ?>",
                method: 'GET',
                data: {
                    category: category.value,
        ...
        function paginateSub(page, subcategory) {
            ...
            let booloffsection = offsection.classList.contains('icon-disenos-offsection');
            $.ajax({
                url: "<?php echo e(route('get.designsbysubcategory')); ?>",
                method: 'GET',
                data: {
...
<?php echo $__env->make('layouts.subliyamaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\subliya\resources\views/web/disenos.blade.php ENDPATH**/ ?>