                ...
                <div class="d-flex flex-column justify-content-start align-items-center w-75 h-75">
                    ...
                    <div class="d-flex justify-content-end align-items-end w-100 py-4">
                        <div class=" icon-disenos">
                            <div class="icon-disenos-onsection mx-3 " id="icon-disenos-onsection" onclick="changeSection()">
                            ...
                            <div class="icon-disenos-offsection" id="icon-disenos-offsection" onclick="changeSection()"><svg
        ...
        <div class="container-fluid width-designs me-sm-0 mx-auto">
                        ...
                        <div class="card border-0 d-flex flex-row justify-content-center ">
                            ...
                            @foreach ($design->records as $record)
                                @if ($loop->first)
                                    ...
                                    <img src="{{ $record->url }}" class="card-img-top animate" alt="Imagen del producto">
                                @else
                                @endif
                            @endforeach
                            @if (count($design->records) == 0)
                                <img src="../img/default.png" class="card-img-top animate" alt="Imagen del producto">
                            @else
                            @endif
                            <div class="card-body d-none desingsCardBody ">
                                {{-- {{$design}} --}}
            ...
            <nav aria-label="Paginación ">
                <ul class="pagination "id="pagination">
                    <li class="page-item">
                        <a class="page-link"
                            href="http://subliya.com.test/get_detail_all?page={{ $designsweb->links()->paginator->currentPage() - 1 }}">Anterior</a>
                    </li>
                    @foreach ($designsweb->links()->elements[0] as $key => $item)
                        <li class="page-item"><a class="page-link" href="{{ $item }}">{{ $key }}</a>
                        </li>
                    @endforeach
                    ...
                    <li class="page-item">
                        @if ($designsweb->links()->paginator->currentPage() + 1 >= $designsweb->links()->paginator->lastPage())
                            <a class="page-link"
                                href="http://subliya.com.test/get_detail_all?page={{ $designsweb->links()->paginator->lastPage() }}">Siguiente</a>
                        @else
                            <a class="page-link"
                                href="http://subliya.com.test/get_detail_all?page={{ $designsweb->links()->paginator->currentPage() + 1 }}">Siguiente</a>
                        @endif
                    </li>
                </ul>
            </nav>
...
@section('js')
    <script>
                    ...
                    if (boolonsection == true && booloffsection == true) {
                        ...
                        $.each(data.data, function(index, element) {
                            ...
                            disenos.append(
                                ...
                                '<div class="card-body  desingsCardBody ">' +
                                '<h5 class="card-title">' + element.name + '</h5>' +
                                '<p class="card-text ">' + descriptionelementfirst +
        ...
        function changebysubcategory(param) {
