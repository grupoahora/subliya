...
@section('contentbody')
            ...
            <div class="col-12 col-lg-4 ms-auto">
                <div class="row ">
                    <div class="col-7 col-lg-6 ms-auto">
                        ...
                        <form class="d-none" action="{{ route('get.designsbycategoryprueba') }}" method="get">
                            @csrf

                            <div id="inputformdesignsbycategoryprueba">


                            </div>

                            <button type="submit" class="d-none" id="designsbycategory"></button>
                        </form>
                    </div>
    ...
    <div class="container">
        <div
            ...
            @if (isset($designsbycategory))
                @foreach ($designsbycategory as $design)
            ...
            <ul class="pagination mt-4 justify-content-center align-items-center" id="pagination">
                @if (isset($designsbycategory))
                    <li class="page-item"><a class="page-link"
                            href="?page={{ $designsbycategory->currentPage() - 1 }}&category={{ $categoryselect }}">Anterior</a>
                    </li>
                    <li class="page-item"><a class="page-link" href="?page=1&category={{ $categoryselect }}">1</a></li>
                    <li class="page-item"><a class="page-link" href="?page=2&category={{ $categoryselect }}">2</a></li>
                    <li class="page-item"><a class="page-link" href="?page=3&category={{ $categoryselect }}">3</a></li>
                    <li class="page-item"><a class="page-link"
                            href="?page={{ $designsbycategory->currentPage() + 1 }}&category={{ $categoryselect }}">Siguiente</a>
                    </li>
                @else
                    <li class="page-item"><a class="page-link"
                            href="?page={{ $designsweb->currentPage() - 1 }}">Anterior</a></li>
                    <li class="page-item"><a class="page-link" href="?page=1">1</a></li>
                    <li class="page-item"><a class="page-link" href="?page=2">2</a></li>
                    <li class="page-item"><a class="page-link" href="?page=3">3</a></li>
                    <li class="page-item"><a class="page-link"
                            href="?page={{ $designsweb->currentPage() + 1 }}">Siguiente</a></li>
                @endif
...
@section('js')
    <script>
        ...
        function prueba() {
            ...
            var buttonform = $('#designsbycategory');
            var category = document.querySelector(".select-disenos");
            var inputformdesignsbycategoryprueba = $('#inputformdesignsbycategoryprueba');
            inputformdesignsbycategoryprueba.empty();
            inputformdesignsbycategoryprueba.append(
    ...
    <script>
        ...
        function changeDisenos() {
            ...
            carddisenos.toggleClass('align-items-center');
