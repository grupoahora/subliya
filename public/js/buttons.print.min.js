    ...
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (d) {
        ...
        u.ext.buttons.print = {
            ...
            action: function (a, e, p, k) {
                ...
                } else e.buttons.info(e.i18n("buttons.printErrorTitle", "No se puede abrir la vista de impresión "), e.i18n("buttons.printErrorMsg ", "Permita ventanas emergentes en su navegador para que este sitio pueda ver la vista de impresión."), 5E3)},
                    title: "*",
                    messageTop: "*",
                    messageBottom: "*",
                    exportOptions: {},
