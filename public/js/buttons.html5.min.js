        ...
        action: function (a, c, d, b) {
            ...
            if (x.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (p) {
                        c.buttons.info(c.i18n("buttons.copyTitle", "Copiar al portapapeles"), c.i18n("buttons.copySuccess", {
            ...
            p =
                n("<span>" + c.i18n("buttons.copyKeys", "Presione < i > ctrl < /i> o <i>⌘</i > + < i > C < /i> para copiar los datos de la tabla<br>al portapapeles de su sistema.<br><br>Para cancelar, haga clic en este mensaje o presione escape.") + "</span > ").append(d);
            c.buttons.info(c.i18n("buttons.copyTitle", "Copiar al portapapeles "), p, 0);
            b[0].focus();
            b[0].select();
